...
<head>
  ...
  <meta name="description" content="Omnifood is imaginary food delivery company for which I created a website while doing a HTML5 and CSS3 course on Udemy.com">
...
<body>
  ...
  <section class="section-steps" id="works">
    ...
    <div class="row">
      <div class="col span-1-of-2 steps-box">
        <img src="resources/img/app-iPhone.png" alt="Omnifood iPhone" class="app-screen js--wp-2">
      </div>
      <div class="col span-1-of-2 steps-box">
    ...
    <div class="row">
      <div class="col span-1-of-3">
        <blockquote>
          ...
          <cite><img src="resources/img/customer-1.jpg" alt="Dzevad Alicic">Dzevad Alicic</cite>
        </blockquote>
      </div>
      <div class="col span-1-of-3">
        <blockquote>
  ...
  <div class="map-box">
    ...
    <div class="form-box" id="form">
      ...
      <div class="row">
        <?php
        if ($_GET['success'] == 1) {
            echo "<div class=\"form-messages success\">Thank you for your message.</div>";
        }
        if ($_GET['success'] == -1) {
            echo "<div class=\"form-messages error\">Message not sent. You must fill all form fields.</div>";
        }
        ?>
  ...
  <footer>
    ...
    <div class="row">
      <p>
        Copywright &copy; 2016 by Samir Alibabic. All rights reserverd.
      </p>
    </div>
